  ...
  return (
    <div className="menu-div">
      <Row className="menu d-flex mt-2 px-5 justify-content-end">
        <Col lg={2} md={2}></Col>
        <Col lg={8} md={8} className="menu-left d-flex justify-content-center">
          <Link
            href="/"
          ...
          <Link href="/use" className="py-3">
            How to Use
          </Link>
          <Link href="/inquiry" className="py-3">
            Inquiry
          </Link>
        ...
        <Col lg={2} md={2} className="menu-right d-flex">
          <Link href="#" className="px-2 py-3">
            Log In
          </Link>
          <div className="fav-cart px-2 py-3">
      ...
      <div className="category">
        <div className="category-title d-flex p-2 justify-content-around align-items-center">
